...
**Figure 3.** Schematic overview of the simulation routine. The
...
any model misspecification. Y-axis truncated to improve readability. Boxplot elements are as described for Figure 5.
...
\vspace{1em} 
**Figure 9.** Estimated sex transition and male reproductive value ($RV_M$) functions under different OM and EM configurations.
