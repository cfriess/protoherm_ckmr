...
lettering refers to each row of plots: a) Base (no skipped spawning, $RV_M$ = $RV_F$, $H_\mathrm{mt}^{EM} = H_\mathrm{mt}^{OM}$); 
b) skipped spawning; c) $H_\mathrm{mt}^{EM} < H_\mathrm{mt}^{OM}$; d) $H_\mathrm{mt}^{OM} < H_\mathrm{mt}^{EM}$; 
e) $RV_M$ flatter than $RV_F$; f) $RV_M$ steeper than $RV_F$.
