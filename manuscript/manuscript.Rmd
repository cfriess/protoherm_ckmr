...
abstract: |
  ...
  uncertainty in male contribution to reproductive success and ability to correctly assign sex of the 
  parent in kin pairs. 
  ...
  is not misspecified and the level of mitochondrial haplotype diversity 
...
groups (Section 2.7): one focused on the effect of parental sex assignment accuracy, 
...
assignment accuracy and the second explores uncertainty surrounding male contribution to reproductive success.
...
declining male abundance had no effect (all eggs produced by females will get fertilized, 
...
to 1, everything else was as in the base scenario.

3. $\Hmte$ < $\Hmts$: In this scenario, $\Hmts$ was set to 1 while $\Hmte$ was set 
to 0.9, everything else was as in the base scenario.
...
$\Hmt$ was not misspecified and this or the following two scenarios.
...
(with older individuals contributing substantially more than younger ones; Figure 2A) 
...
## 3.5 Effect of Parental Sex Assignment Accuracy
...
## 4.1 Effect of Parental Sex Assignment Accuracy
...
than our simplistic model, but perhaps with the right data, this is an achievable goal. Unlike
...
C.F.: Conceptualization, methodology, formal analysis, validation, visualization, writing - original draft; 
E.C.A.: Conceptualization, methodology, formal analysis, validation, visualization, writing - original draft;
